        ...
        <>
          <Card className="bg-gray-700 p-4 md:p-7 lg:p-7 m-5 rounded-3xl">
              ...
              <div className="text-white text-xs md:text-base lg:text-lg p-3">
                ...
                <div >
                <li>Write only one correct answer, highlighted in green for clarity.</li>
                <li>Input the correct answer in the first box; our system will shuffle answers.</li>
                <li>Ensure all fields, including questions and answers, are filled; no blanks allowed.</li>
                <li>Duplicate correct answers are accepted; both will be considered correct.</li>
                <li>Use the remove button to delete questions entirely if necessary.
                </li>
                </div>
              </div>
                    ...
                    {JSON.parse(question.options).map(
                      (option: string, index: number) => (
                        <input
                          ...
                          defaultValue={option}
                          onChange={(e) => {
                            handleOptions(questionIndex, index, e.target.value);
                          }}
                        />
                      )
                    )}
