    ...
    if (shared) {
      if (quizState.type === "mcq") {
        router.push(
          "/create-quiz/mcq" +
            "?" +
            createQueryString("obj", JSON.stringify(quizState))
        );
      } else {
        router.push(
          "/create-quiz/blanks" +
              ...
              <form action="#" method="POST" className="mt-8">
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center space-x-2">
                    <button
                      className={`flex align-center items-center px-4 py-2 rounded-md hover:bg-gray-700 ${
                        selectedType === "mcq" ? "bg-gray-700" : ""
                      }`}
                      onClick={() => {
                    ...
                    <button
                      className={`flex align-center items-center px-4 py-2 rounded-md hover:bg-gray-700 ${
                        selectedType === "blanks" ? "bg-gray-700" : ""
                      }`}
                      onClick={() => {
                  ...
                  <div className="flex justify-between space-x-2">
                    <button
                      className={`flex align-center items-center px-4 py-2 rounded-md hover:bg-gray-700 ${
                        selectedDifficulty === "easy" ? "bg-green-700" : ""
                      }`}
                      onClick={() => {
                    ...
                    <button
                      className={`flex align-center items-center px-4 py-2 rounded-md hover:bg-gray-700 ${
                        selectedDifficulty === "medium" ? "bg-yellow-700" : ""
                      }`}
                      onClick={() => {
                    ...
                    <button
                      className={`flex align-center items-center px-4 py-2 rounded-md hover:bg-gray-700 ${
                        selectedDifficulty === "hard" ? "bg-red-700" : ""
                      }`}
                      onClick={() => {
