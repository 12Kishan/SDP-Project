...
export default function ReserPassword({ params }: { params: { email: string } }) {
            ...
            <div className="flex items-center justify-center px-4 sm:px-6 h-screen sm:py-16 lg:px-8 lg:py-24">
                <div className="className= bg-gray-900 rounded-3xl px-7 py-7 text-white w-[400px]">
                    <div className="xl:mx-auto items-center xl:w-full xl:max-w-sm 2xl:max-w-md">
                        ...
                        <h1 className="text-center text-2xl font-bold leading-tight text-white">Reset Password</h1>
                        ...
                        <form>
                            <div mt-3>
                                <div className="flex items-center justify-between">
                                    ...
                                    <label htmlFor="" className="text-sm font-medium text-gray-300 block m-3">
                                        {' '}
                                        Password{' '}
                                    </label>
                                ...
                                <input className="flex h-10 w-full rounded-md border text-white border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                                    type="Password"
                            ...
                            <div mt-3>
                                ...
                                <label htmlFor="" className="text-sm font-medium text-gray-300 block m-3">Conform Password</label>
